	...
	public class BindUnity {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_UnityEngine_InteractiveCloth.reg,
				Lua_UnityEngine_ClothSkinningCoefficient.reg,
				Lua_UnityEngine_SkinnedCloth.reg,
				Lua_UnityEngine_Renderer.reg,
				Lua_UnityEngine_ClothRenderer.reg,
				...
				Lua_UnityEngine_ParticleSystem_CollisionEvent.reg,
