...
public class Lua_UnityEngine_Motion : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_isAnimatorMotion(IntPtr l) {
		try {
			UnityEngine.Motion self=(UnityEngine.Motion)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.isAnimatorMotion);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,ValidateIfRetargetable);
		...
		addMember(l,"isAnimatorMotion",get_isAnimatorMotion,null,true);
